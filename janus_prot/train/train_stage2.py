...
from janus_prot.data import collate_fn_mm, Seq40StructDataset, SeqStructureDataset
...
def train():
    ...
    train_dataset = Seq40StructDataset(
        data_args.train_lmdb_path, 
        data_args.train_struct_path,
