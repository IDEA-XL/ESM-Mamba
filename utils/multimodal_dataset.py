...
class SeqStructMixDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        struct2seq_path = "/cto_studio/xtalpi_lab/temp/swiss_prot_esm3/batch_0"
        self.file_list = glob.glob(struct2seq_path + '/AF-*_v4.pkl')
...
class SeqStructureDataset(torch.utils.data.Dataset):
    """
    Structure and sequence dataset in the format of "1ABC23sAsB4" or "2CBA14sBsA3"
    Parameters:
        lmdb_path (`str`):
...
class ProgenSeqDataset(torch.utils.data.Dataset):
    """
